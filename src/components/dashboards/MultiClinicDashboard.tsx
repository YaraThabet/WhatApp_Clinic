...
export default function MultiClinicDashboard({ initialView = 'dashboard' }: { initialView?: string }) {
    const { language, toggleLanguage } = useLanguage();
    const t = translations[language];
    // Default to the Clinic Dashboard overview
    ...
    const sidebarItems = [
        { id: 'dashboard', name: t.dashboard.sidebar.dashboard, icon: LayoutDashboard },
        { id: 'doctors', name: t.dashboard.sidebar.doctors, icon: Stethoscope },
        { id: 'patients', name: t.dashboard.sidebar.patients, icon: Users },
        { id: 'appointments', name: t.dashboard.sidebar.appointments, icon: Calendar },
        { id: 'calendar', name: t.dashboard.sidebar.calendar, icon: Calendar },
        { id: 'billing', name: t.dashboard.sidebar.billing, icon: CreditCard },
        { id: 'staff', name: t.dashboard.sidebar.staff, icon: UserCog },
        { id: 'reports', name: t.dashboard.sidebar.reports, icon: FileText },
        { id: 'settings', name: t.dashboard.sidebar.settings, icon: Settings },
    ]
